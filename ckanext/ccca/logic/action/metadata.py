...
from ckanext.ccca.common import logic
from ckanext.ccca.common import base
from ckanext.ccca.common import config
from ckanext.ccca.common import app_globals
...
def get_html_ccca(context, data_dict):
    ...
    data_dict['errors']={};
    return render("package/snippets/package_md_fields_ccca.html", data_dict)
...
def get_html_iso(context, data_dict):
    ...
    data_dict['data']=pkg_dict;
    data_dict['errors']={};
    return render("package/snippets/package_md_fields_iso.html", data_dict)
...
def get_html_inspire(context, data_dict):
    ...
    data_dict['data']=pkg_dict;
    data_dict['errors']={};
    return render("package/snippets/package_md_fields_inspire.html", data_dict)
...
def iso_19139(context, data_dict):
    ...
    output = base.render("xml/package_to_iso.html", pkg)
